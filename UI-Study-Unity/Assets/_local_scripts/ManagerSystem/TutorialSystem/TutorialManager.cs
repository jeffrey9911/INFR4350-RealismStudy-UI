...
public class TutorialManager : MonoBehaviour
{
    ...
    private void TriggerStep1() // Right hand trigger: Select and Click
    {
        ...
        if(RuntimeManager.Instance.UI_MANAGER.CurrentMode == 0) // Skeuomorphic
        {
            if(RuntimeManager.Instance.UI_MANAGER.CurrentHeadsetType == 0) // Quest 2
            {
                Q2_R_HandTrigger.SetActive(true);
            }
            else if(RuntimeManager.Instance.UI_MANAGER.CurrentHeadsetType == 1) // Pro
            {
                PRO_R_HandTrigger.SetActive(true);
            }

        }
        else if(RuntimeManager.Instance.UI_MANAGER.CurrentMode == 1) // Flat
        {
    ...
    private void TriggerStep2() // Left joystick: Move
    {
        ...
        if (RuntimeManager.Instance.UI_MANAGER.CurrentMode == 0) // Skeuomorphic
        {
            if (RuntimeManager.Instance.UI_MANAGER.CurrentHeadsetType == 0) // Quest 2
            {
                Q2_L_Joystick.SetActive(true);
            }
            else if (RuntimeManager.Instance.UI_MANAGER.CurrentHeadsetType == 1) // Pro
            {
                PRO_L_Joystick.SetActive(true);
            }
    ...
    private void TriggerStep3() // Right joystick: Rotate
    {
        ...
        if (RuntimeManager.Instance.UI_MANAGER.CurrentMode == 0) // Skeuomorphic
        {
            if (RuntimeManager.Instance.UI_MANAGER.CurrentHeadsetType == 0) // Quest 2
            {
                Q2_R_Joystick.SetActive(true);
            }
            else if (RuntimeManager.Instance.UI_MANAGER.CurrentHeadsetType == 1) // Pro
            {
                PRO_R_Joystick.SetActive(true);
            }
    ...
    private void TriggerStep4() // Right oculus: Recentre
    {
        ...
        if (RuntimeManager.Instance.UI_MANAGER.CurrentMode == 0) // Skeuomorphic
        {
            if (RuntimeManager.Instance.UI_MANAGER.CurrentHeadsetType == 0) // Quest 2
            {
                Q2_R_Oculus.SetActive(true);
            }
            else if (RuntimeManager.Instance.UI_MANAGER.CurrentHeadsetType == 1) // Pro
            {
                PRO_R_Oculus.SetActive(true);
            }
    ...
    private void TriggerStep5() // Left oculus: Hide/Display
    {
        ...
        if (RuntimeManager.Instance.UI_MANAGER.CurrentMode == 0) // Skeuomorphic
        {
            if (RuntimeManager.Instance.UI_MANAGER.CurrentHeadsetType == 0) // Quest 2
            {
                Q2_L_Oculus.SetActive(true);
            }
            else if (RuntimeManager.Instance.UI_MANAGER.CurrentHeadsetType == 1) // Pro
            {
                PRO_L_Oculus.SetActive(true);
            }
    ...
    private void TriggerStep6() // Left or right grip trigger: Move UI
    {
        ...
        if (RuntimeManager.Instance.UI_MANAGER.CurrentMode == 0) // Skeuomorphic
        {
            if (RuntimeManager.Instance.UI_MANAGER.CurrentHeadsetType == 0) // Quest 2
            {
                Q2_L_GripTrigger.SetActive(true);
                Q2_R_GripTrigger.SetActive(true);
            }
            else if (RuntimeManager.Instance.UI_MANAGER.CurrentHeadsetType == 1) // Pro
            {
                PRO_L_GripTrigger.SetActive(true);
                PRO_R_GripTrigger.SetActive(true);
            }
    ...
    private void TriggerStepEnd()
    {
        ...
        RuntimeManager.Instance.SURVEYTIME_MANAGER.StopTutorialTimer();
    ...
    public void TutorialButtonOnClick(Button button)
    {
        ...
        RuntimeManager.Instance.SURVEYTIME_MANAGER.StartTutorialTimer();
    }
